...
namespace WordSearch
{
	public class LanguageController : SingletonComponent<LanguageController>
	{
		...
		private new void Awake()
		{
			...
			this.Text_UIScreenMain_Title.Add("The God of\nWord Search");
			this.Text_UIScreenMain_Btn_Classic.Add("Classic\nMode");
			this.Text_UIScreenMain_Btn_Quick.Add("Quick\nStart");
			this.Text_UIScreenMain_Btn_Challenge.Add("Challenge\nMode");
			this.Text_UIScreenMain_Btn_Quiz.Add("Quiz\nMode");
